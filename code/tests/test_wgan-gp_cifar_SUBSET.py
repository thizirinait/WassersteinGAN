...
from utils import weights_init, get_indices
...
n_epochs = 100
display_step = 200          # Frequency for saving images
clip_value = None           # if None: no clipping -> gradient penalty instead
n_disc = 3                  # How many more times the discriminator (=critic) is trained compared to the generator? (-> see WGAN paper)
...
idx = get_indices(trainset, 1)
dataloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size, num_workers=2,
